...
public class u6_slider_ctrl : MonoBehaviour
{
    ...
    private string keyframesDataKey = "KeyframesData";
    ...
    private void SaveKeyframes_jsonFormat()
    {
    ...
    {
        public List<RobotKeyframe> keyframes;

        public KeyframesData(List<RobotKeyframe> keyframes)
        {
